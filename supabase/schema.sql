-- ============================================================
-- HR Leave & Permission Management System — Supabase Schema
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_perm_requests_employee_id  ON public.permission_requests(employee_id);
...
CREATE POLICY "Employees can update own limited fields" ON public.employees
...
CREATE POLICY "Users can view own notifications" ON public.notifications
  FOR SELECT USING (user_id = auth.uid() OR employee_phone IS NOT NULL);

DROP POLICY IF EXISTS "Users can update own notifications" ON public.notifications;
CREATE POLICY "Users can update own notifications" ON public.notifications
  FOR UPDATE USING (user_id = auth.uid() OR employee_phone IS NOT NULL);

DROP POLICY IF EXISTS "HR can insert notifications" ON public.notifications;
CREATE POLICY "HR can insert notifications" ON public.notifications
...
CREATE POLICY "Allow all access to push subscriptions" ON public.push_subscriptions
...
CREATE POLICY "HR can view audit logs" ON public.audit_logs
  FOR SELECT USING (
    EXISTS (SELECT 1 FROM public.profiles WHERE id = auth.uid() AND role IN ('admin', 'hr'))
  );
...
-- ============================================================
-- RLS Policies for permission_credits
-- ============================================================
...
-- ============================================================
-- Seeding function for permission credits
-- ============================================================
...
-- Or: UPDATE public.profiles SET role = 'hr' WHERE id = 'YOUR-AUTH-USER-UUID';
