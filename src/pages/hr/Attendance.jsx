    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <div className="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm text-center">
          ...
          <p className="text-2xl font-bold text-yellow-600 mt-1">{summaries.leave}</p>
        </div>
        <div className="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm text-center">
                    ...
                    <tr key={emp.phone} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        {isCurrentDateHoliday ? (
                          ...
                          <span className="text-xs font-bold text-yellow-800 bg-yellow-50 border border-yellow-200 rounded-lg px-3 py-1.5" title={`${onLeave} Approved`}>
                            🌴 Leave ({onLeave})
                          </span>
                        ) : (
                          <select
                            ...
                            className={`px-3 py-1.5 text-xs font-bold rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-100 ${
                              ...
                              status === 'LEAVE' ? 'bg-yellow-500 text-slate-800 border-yellow-500' :
                          ...
                          >
                            ...
                            <option value="LEAVE" className="bg-white text-yellow-600 font-bold">Leave</option>
