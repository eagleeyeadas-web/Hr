      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 bg-white rounded-xl border border-slate-100 p-5 space-y-4 h-fit">
          <h2 className="font-semibold text-lg text-slate-800 flex items-center gap-2">
            <Calendar size={18} className="text-blue-500" /> Comp-Off Generation
          </h2>

          <div className="rounded-lg p-3.5 text-xs leading-relaxed bg-blue-50 border border-blue-100 text-blue-800 space-y-2">
            <p className="font-bold">⚠️ Automatic Processing</p>
            <p>
              Comp-Off credits are now automatically generated by the attendance management system when you work on your weekly off days.
            </p>
            <p>
              <strong>Senior Employees:</strong> Earn Comp-Off for Saturday or Sunday attendance.
            </p>
            <p>
              <strong>Junior Employees:</strong> Earn Comp-Off for Sunday attendance only.
            </p>
            <p>
              Manual submissions are no longer supported. Please check your credit balance and history on this page.
            </p>
          </div>

          {employeeType && (
            <div className="flex items-center gap-2 pt-2">
              <span className="text-xs text-slate-500">Your Type:</span>
